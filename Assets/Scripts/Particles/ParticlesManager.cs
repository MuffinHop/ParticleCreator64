...
{
    // Class to store position and bit data of a trunk
    public class TrunkPosition
    {
        public Vector3b Position; // Position encoded as Vector3b
        public Vector3b Bits; // Bit data for position encoding
    ...
    // Class to store baked particles data
    public class BakedParticles
    {
        ...
        public byte[] Bytestream = new byte[1024 * 1024 * 8];
        public int MaxBitstream;
    }

    // Tracks for particle effects
    ...
    // Baked particles data and other variables
    ...
    // Method to count the number of bits required to represent a value
    ...
    // Method to compress particle data
